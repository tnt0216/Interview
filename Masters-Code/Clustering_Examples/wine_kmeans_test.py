...
# See how silhouette responds to more dimensions to optimize the clustering (ideally it should converge)
# put graphs and such for code in powerpoint slides
# Try another cluster analysis
